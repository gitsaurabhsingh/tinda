...
$loginView = $dir . '/resources/views/auth/login.blade.php';
$loginHtml = <<<HTML
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Login - {{ \$settings['site_name'] ?? 'Tindablog' }}</title>
    <!-- Fonts -->
...
<body>
    <a href="/" class="back-home"><i class="fa-solid fa-arrow-left me-2"></i> Back to Home</a>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="d-flex justify-content-between align-items-center mb-5">
                <div class="form-check">
                    ...
                    <label for="remember_me" class="form-check-label ms-1">Remember me</label>
                </div>
            ...
            <button class="btn btn-primary w-100 mb-4" type="submit">Sign In <i class="fa-solid fa-arrow-right ms-2"></i></button>
...
HTML;
file_put_contents($loginView, $loginHtml);

// 2. Redesign Register Page
$registerView = $dir . '/resources/views/auth/register.blade.php';
$registerHtml = <<<HTML
<!DOCTYPE html>
<html lang="en">
<head>
...
HTML;
file_put_contents($registerView, $registerHtml);

echo "Login and Register pages redesigned.";
