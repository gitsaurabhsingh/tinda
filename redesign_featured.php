...
// Let's replace the whole featured block to make it cleaner.
$startSection = strpos($content, '<!-- Modern Featured Blogs Section -->');
$endSection = strpos($content, '<!-- Magazine Style 3-Column Layout -->');
...
EOT;
    $content = substr($content, 0, $startSection) . $featuredHTML . substr($content, $endSection);
    file_put_contents('resources/views/welcome.blade.php', $content);
    echo "Redesigned Featured Carousel.\n";
}
